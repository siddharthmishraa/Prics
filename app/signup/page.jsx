      ...
      <div className="min-h-screen flex justify-center items-center bg-gray-100 fixed top-0 left-0 w-full">
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-sm w-full">
          ...
          <p className="text-center text-gray-500 mb-6">
            Find suggestions you didn't know you needed for your next reel.
          </p>
          ...
          <input
            ...
            className="w-full p-3 border border-gray-300 rounded-lg mb-3 focus:outline-none focus:ring-2 focus:ring-black-500"
            value={username}
          ...
          <p className="text-xs text-center text-gray-500 mt-4">
            By continuing, you agree to PRICS's{" "}
